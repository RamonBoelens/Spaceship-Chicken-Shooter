...
public class TopDownCamera : MonoBehaviour
{
    ...
    private Vector3 GetPerfectPosition()
    {
        ...
        float heightX = 90F / camera.fieldOfView * Mathf.Abs(bounds.max.x - bounds.center.x);
        float heightZ = 90F / camera.fieldOfView * Mathf.Abs(bounds.max.z - bounds.center.z);
